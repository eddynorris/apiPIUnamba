...
type Investigador struct {
	...
	Apellido  string `json:"apellido" db:"apellido"`	Rol       string `json:"rol" db:"rol"`
}
...
type DetalleGrupoInvestigador struct {
	...
	IDInvestigador int    `json:"idInvestigador" db:"idInvestigador"`	TipoRelacion string `json:"tipoRelacion" db:"tipoRelacion"`
}
